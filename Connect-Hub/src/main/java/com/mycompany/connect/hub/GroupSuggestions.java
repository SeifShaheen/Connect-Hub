...
public class GroupSuggestions extends javax.swing.JFrame {
     ...
     */
    public GroupSuggestions() throws IOException, NoSuchAlgorithmException {
        initComponents();
        setVisible(true);
        setTitle("Groups Suggestions");
        setResizable(false);
        this.setDefaultCloseOperation(JFrame.DISPOSE_ON_CLOSE);
        mainPanel.setVisible(true);
        mainPanel.setLayout(new BoxLayout(mainPanel, BoxLayout.Y_AXIS));
        UserGroupConnections u = new UserGroupConnections(ConnectHub.currentUser);
        ArrayList<Group> sugg = u.suggestions();
        // System.out.println(sugg);
        for (Group g : sugg) {
            mainPanel.add(new GroupSuggetPanel(g));
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(GroupSuggestions.class.getName()).log(java.util.logging.Level.SEVERE,
                    null,
                    ex);
