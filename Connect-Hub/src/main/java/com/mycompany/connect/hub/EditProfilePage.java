...
public class EditProfilePage extends javax.swing.JFrame {
        ...
        public EditProfilePage() {
                ...
                if (profilePath != null) {
                        profilePicture.setIcon(section(profilePath, null, profilePicture.getWidth(),
                                        profilePicture.getHeight()));
                } else {
                        profilePicture.setIcon(section("src\\main\\java\\icons\\profile-user.png", null,
        ...
        public static ImageIcon section(String imag, byte[] image, int width, int height) {
                ...
                Image img2 = img1.getScaledInstance(width, height, Image.SCALE_SMOOTH);// Resize the image to fit the
                                                                                       // JLabel
                // (profilePicture)
        ...
        private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {// GEN-FIRST:event_jButton1ActionPerformed
                ...
                if (returnValue == JFileChooser.APPROVE_OPTION) {
                        ...
                        profilePicture.setIcon(
                                        section(path, null, profilePicture.getWidth(), profilePicture.getHeight()));
        ...
        private void jButton5ActionPerformed(java.awt.event.ActionEvent evt)
                        throws IOException, NoSuchAlgorithmException {// GEN-FIRST:event_jButton5ActionPerformed
                if (PasswordHashing.checkPassword(new String(currentPassword.getPassword()),
                                ConnectHub.currentUser.getPassword())) {
        ...
        public static void main(String args[]) {
                ...
                try {
                        ...
                        java.util.logging.Logger.getLogger(EditProfilePage.class.getName()).log(
